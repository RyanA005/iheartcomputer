...
<body>
  <div class="main">
    <header class="header">
      ...
      <nav class="nav">
        <a class="link" href="/old/">home</a>
        <a class="link" href="https://discord.gg/JpRw84Ybwg" target="_blank">discord</a>
        <a class="link" href="/old/projects/">projects</a>
      </nav>
    </header>
    ...
    <div class="content">
      <?php if (!$authed): ?>
        ...
        <br>
        <form method="post" action="/old/admin/" style="display:flex; flex-direction:column; gap:10px; align-items:center;">
      ...
      <?php else: ?>
        ...
        <br>
        <div class="small"><a class="link" href="/old/admin/?logout=1">logout</a></div>
      <?php endif; ?>
    </div>
  </div>
</body>
